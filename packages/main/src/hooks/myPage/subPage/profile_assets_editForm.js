...
const profileAssetEdit = ( signals, docName ) => {

    console.log('asset editForm opened!! docName: ', docName )

    let tabPane = new UIDiv().setAttr({ 'class':'tab-pane fade', 'id':'edit-asset', 'role':'tabpanel', 'aria-labelledby':'edit-assets-tab' });
