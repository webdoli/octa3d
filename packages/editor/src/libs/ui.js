...
//properties
    const properties = [ 'position', 'left', 'top', 'right', 'bottom', 'width', 'height', 'border', 
        'borderLeft', 'borderTop', 'borderRight', 'borderBottom', 'borderColor', 'display', 'overflow', 
        'margin', 'marginLeft', 'marginTop', 'background', 'backgroundColor', 'opacity', 'fontSize', 
        'fontWeight', 'textAlign', 'textDecoration', 'textTransform', 'cursor', 'zIndex', 'marginRight', 
        'marginBottom', 'padding', 'paddingLeft', 'paddingTop', 'paddingRight', 'paddingBottom', 
        'verticalAlign', 'color'];
    ...
    events.forEach( (evt) => {
        const method = 'on' + evt;
        UIElement.prototype[ method ] = function(cb){
    ...
    class UINumber extends UIElement{
        constructor( number ){
            ...
            const changeEvent = document.createElement( 'HTMLEvents' );
            ...
            function onMouseDown(evt) {
                ...
                prevPointer.x = evt.clientX;
                prevPointer.y = evt.clientY;
            ...
            function onMouseMove( evt ){
                ...
                let value = onMouseDownValue + ( distance / (evt.shiftKey ? 5 : 50 ) ) * scope.step;
            ...
            function onTouchStart( evt ){
                if( evt.touches.length === 1 ){
                    ...
                    prevPointer.x = evt.touches[ 0 ].pageX;
                    prevPointer.y = evt.touches[ 0 ].pageY;
            ...
            function onTouchMove(evt){
                const currentValue = scope.value;
                pointer.x = evt.touches[0].pageX;
                pointer.y = evt.touches[0].pageY;
    ...
    class UIInteger extends UIElement{
        constructor( number ){
            ...
            this.dom.setAttribute( 'autocomplte', 'off' );
            this.value = 0;
...
export { UIElement, UISpan, UIDiv, UIRow, UIText, UIInput, UITextArea, UISelect, UIPanel,
        UICheckbox, UIColor, UINumber, UIInteger, UIBreak, UIHorizontalRule, UIButton, 
        UIProgress, UITabbedPanel, UIListbox, ListboxItem, UIUl, UILi }